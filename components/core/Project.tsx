        ...
        <>
            <div className="">
                ...
                <div className="flex flex-col flex-wrap md:flex-row justify-center gap-12 md:gap-0 mb-12 md:mb-16 overflow-hidden">
                    {prods.map((p, i) => (
                        <div data-aos={i % 2 === 0 && i + 1 == prods.length ? "fade-up" : i % 2 === 0 ? "fade-left" : "fade-right"} key={i} className={`w-full md:w-[520px] lg:w-[620px] mb-6 px-0 md:px-[60px] ${i % 2 === 0 && i + 1 == prods.length ? '' : i % 2 === 0 ? 'md:border-r md:border-gray-200' : ''}`}>
